...
sg_map +
  ...
  tm_add_legend(type = "symbol",
                labels = c("HDB carpark", "Bus stop", "LRT/MRT exit"),
                col = c("black", "blue", "red"), shape = 21)
...
sg_map +
  ...
  tm_add_legend(type = "line",
                labels = c("HDB carpark SDD", "Bus stop SDD", "LRT/MRT exit SDD"),
                col = c("black", "blue", "red"), lty=2) + 
  tm_add_legend(type = "line",
                labels = c("HDB carpark SDE", "Bus stop SDE", "LRT/MRT exit SDE"),
...
qc3 = quadratcount(rail.ppp, nx=20, ny=20)
...
(max.freq = max(observed))
plot(c(0,max.num),c(0,max.freq), type="n", 
     xlab="Number of LRT/MRT exits per quadrat (red = observed, blue = expected)", 
     ylab="Frequency of occurrences", main="Quadrat counts: observed vs expected")
points(dpois(0:max.num, lambda=lambda)*n, type="l", col="Blue", lwd=2)
points(observed, col="Red", type="l", lwd=2)
```
